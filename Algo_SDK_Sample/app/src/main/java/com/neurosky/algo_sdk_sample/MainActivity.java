...
public class MainActivity extends Activity {
    ...
    public float gamma_con;
    public float theta_con;
    public float alfa_con;
    public float beta_con;
    public float deltha_con;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        graph_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent connection=new Intent(MainActivity.this,GraphActivity.class);
                connection.putExtra("theta",theta_con);
                connection.putExtra("delta",deltha_con);
                connection.putExtra("alpha",alfa_con);
                connection.putExtra("beta",beta_con);
                connection.putExtra("gamma",gamma_con);
        ...
        progress_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent progress=new Intent(MainActivity.this,Calendario.class);
        ...
        nskAlgoSdk.setOnBPAlgoIndexListener(new NskAlgoSdk.OnBPAlgoIndexListener() {
            @Override
            public void onBPAlgoIndex(final float delta, float theta, float alpha, float beta, float gamma) {
                ...
                deltha_con= (float) fDelta;
                theta_con=(float)fTheta;
                alfa_con=(float)fAlpha;
                beta_con=(float)fBeta;
                gamma_con=(float)fGamma;
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        // change UI elements here
                        ...
                        /*
                        Intent connection=new Intent(MainActivity.this,GraphActivity.class);
                        connection.putExtra("theta",fTheta);
                        connection.putExtra("delta",fDelta);
                        connection.putExtra("alpha",fAlpha);
                        connection.putExtra("beta",fBeta);
                        connection.putExtra("gamma",fGamma);
                        */
                        //startActivity(connection);
