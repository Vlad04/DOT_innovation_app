...
public class Graph_progress_empty extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_graph_progress_empty);
...
//series.setValuesOnTopSize(50);
        back_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(Graph_progress_empty.this,MainActivity.class);
